  ...
  return (
    <div className="min-h-screen bg-white dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100">
      <div className="mx-auto max-w-3xl px-4 py-12">
        ...
        <p className="text-sm text-muted-foreground mb-8">Последнее обновление: 11 июля 2026 г.</p>
        <div className="prose prose-zinc dark:prose-invert max-w-none space-y-4 text-sm leading-relaxed">
          ...
          <p>Оплата услуг производится через Telegram Stars (валюта XTR) или банковскую карту / СБП через платёжную систему Platega. Стоимость услуг указана в каталоге. Оплата считается завершённой после подтверждения Telegram (для Stars) или получения статуса CONFIRMED от платёжной системы (для карты/СБП).</p>
